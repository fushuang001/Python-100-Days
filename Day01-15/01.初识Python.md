* [初识Python](#初识python)
   ...
   * [安装Python解释器](#安装python解释器)
      ...
      * [Linux环境](#linux环境)
      * [macOS环境](#macos环境)
   * [运行Python程序](#运行python程序)
      * [确认Python的版本](#确认python的版本)
      * [编写Python源代码](#编写python源代码)
      * [运行程序](#运行程序)
      * [代码中的注释](#代码中的注释)
   * [Python开发工具](#python开发工具)
      * [IDLE - 自带的集成开发工具](#idle---自带的集成开发工具)
      * [IPython - 更好的交互式编程工具](#ipython---更好的交互式编程工具)
      * [Sublime Text - 高级文本编辑器](#sublime-text---高级文本编辑器)
