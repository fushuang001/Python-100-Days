* [函数和模块的使用](#函数和模块的使用)
   ...
   * [用模块管理函数](#用模块管理函数)
   * [练习](#练习)
      * [练习1：实现计算求最大公约数和最小公倍数的函数。](#练习1实现计算求最大公约数和最小公倍数的函数)
      * [练习2：实现判断一个数是不是回文数的函数。](#练习2实现判断一个数是不是回文数的函数)
      * [练习3：实现判断一个数是不是素数的函数。](#练习3实现判断一个数是不是素数的函数)
      * [练习4：写一个程序判断输入的正整数是不是回文素数。](#练习4写一个程序判断输入的正整数是不是回文素数)
   * [变量的作用域](#变量的作用域)
...
if __name__ == '__main__':
    # 输入的需要是数字，不过默认 input() 为 string，需要 int() 变为数字类型
